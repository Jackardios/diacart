...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "31a719d7f0199d49ffd5";
...
function () {
  function Diacart() {
    ...
    _defineProperty(this, "add", function () {
      ...
      if (_this.options.groupBy) {
        ...
        if (id) {
          ...
          added = _this.storage.update(id, updateObject);
        } else {
          added = _this.storage.add(item);
        }

        _this.eventEmitter.emit("add");
      ...
      _this.eventEmitter.emit("add", added);
    ...
    _defineProperty(this, "remove", function (id) {
      ...
      var added = _this.storage.remove(id);
    ...
    _defineProperty(this, "update", function (id, updateObj) {
      var updated = _this.storage.update(id, updateObj);
    ...
    _defineProperty(this, "render", function () {
      if (_this._containers.length) {
        ...
        for (var i = 0; i < _this._containers.length; ++i) {
          Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["render"])(containerCompiled, _this._containers[i]);
        }
      }
      ...
      if (_this._miniContainers.length) {
        ...
        for (var _i = 0; _i < _this._miniContainers.length; ++_i) {
          Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["render"])(miniContainerCompiled, _this._miniContainers[_i]);
        }
      }
      ...
      if (_this._totalPriceContainers.length) {
        ...
        for (var _i2 = 0; _i2 < _this._totalPriceContainers.length; ++_i2) {
          Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["render"])(Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject(), totalPriceCompiled), _this._totalPriceContainers[_i2]);
        }
      }
      ...
      if (_this._totalQuantityContainers.length) {
        ...
        for (var _i3 = 0; _i3 < _this._totalQuantityContainers.length; ++_i3) {
          Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["render"])(Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), totalQuantityCompiled), _this._totalQuantityContainers[_i3]);
        }
      }
    });
  ...
  _createClass(Diacart, [{
    ...
    value: function _calculateTotalPrice() {
      ...
      if (this.options.itemHasPrice) {
        this.storage.forEach(function (item) {
          var quantity = _this3.options.itemHasQuantity && item.quantity ? parseInt(item.quantity) : 1;
    ...
    value: function _calculateTotalQuantity() {
      ...
      var totalQuantity = 0;
      this.storage.forEach(function (item) {
        totalQuantity += _this4.options.itemHasQuantity && item.quantity ? parseInt(item.quantity) : 1;
      });
...
/* harmony import */ var lit_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-html */ "./node_modules/lit-html/lit-html.js");
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n              <div class=\"diacart-empty\">\n                <h2 class=\"diacart-empty__title\">", "</h2>\n              </div>\n            "]);
