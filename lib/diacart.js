...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4f4d46ad96cd4dc7ff64";
    ...
    _defineProperty(this, "render", function () {
      if (_this._containers.length) {
        ...
        for (var i = 0; i < _this._containers.length; ++i) {
          _this.options.render(containerCompiled, _this._containers[i]);
        }
      }
      ...
      if (_this._miniContainers.length) {
        ...
        for (var _i = 0; _i < _this._miniContainers.length; ++_i) {
          _this.options.render(miniContainerCompiled, _this._miniContainers[_i]);
        }
      }
      ...
      if (_this._totalPriceContainers.length) {
        ...
        for (var _i2 = 0; _i2 < _this._totalPriceContainers.length; ++_i2) {
          _this.options.render(Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject(), totalPriceCompiled), _this._totalPriceContainers[_i2]);
        }
      }
      ...
      if (_this._totalQuantityContainers.length) {
        ...
        for (var _i3 = 0; _i3 < _this._totalQuantityContainers.length; ++_i3) {
          _this.options.render(Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), totalQuantityCompiled), _this._totalQuantityContainers[_i3]);
        }
      }
    });
